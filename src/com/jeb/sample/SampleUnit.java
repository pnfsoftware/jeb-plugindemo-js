...
/**
 * Simple unit that does no processing and add a new Ascii Document with the content of the file.
 * 
 * @author Cedric Lucas
 *
 */
public class SampleUnit extends AbstractBinaryUnit {
    ...
    public IUnitFormatter getFormatter() {
        return new UnitFormatterAdapter(new AbstractTransientUnitRepresentation("javascript raw code", true) {
            @Override
