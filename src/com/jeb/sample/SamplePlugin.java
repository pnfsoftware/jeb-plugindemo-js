...
/**
 * Entry Point of the plugin system: provides information related to Plugin and how to detect if the
 * plugin should be used (see {@link #canIdentify(IInput, IUnitCreator)}.<br>
 * 
 * The {@link #prepare(String, IInput, IUnitProcessor, IUnitCreator)} method delegates the
 * processing.
 * 
 * @author Cedric Lucas
 *
